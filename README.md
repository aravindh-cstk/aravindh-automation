...
2. Follow [docs/SETUP-AFTER-SECRETS.md](docs/SETUP-AFTER-SECRETS.md) for push, Actions, and first sync.
3. Author docs with required front matter — see [docs/README.md](docs/README.md).
4. Merge to `main` to trigger sync; use pull requests for lint validation.
